...
use App\Http\Transformers\OrderProductsTransformer;
...
/**
 * Class GerProductsByOrderController
...
class GerProductsByOrderController
{
    ...
    /**
     * GerProductsByOrderController constructor.
    ...
    public function __invoke(Request $request, int $orderID): JsonResponse
    {
        try {
            ...
            $products = $this->dbOrderRepository->findProductsByOrderID($orderID);
