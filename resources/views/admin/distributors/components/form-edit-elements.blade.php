...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('phone'), 'has-success': this.fields.phone && this.fields.phone.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-2' : 'col-md-3 col-xl-3'">
        <select v-model="form.country_code_user" class="form-control" name="country_code_user" id="country_code_user">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('second_phone'), 'has-success': this.fields.second_phone && this.fields.second_phone.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-2' : 'col-md-3 col-xl-3'">
        <select v-model="form.country_code" class="form-control" name="country_code" id="country_code">
            <option data-countryCode="CO" value="57">Colombia (+57)</option>
            <option data-countryCode="GB" value="44">UK (+44)</option>
            <option data-countryCode="US" value="1">USA (+1)</option>
            <option data-countryCode="DZ" value="213">Algeria (+213)</option>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('contact_legal_representative'), 'has-success': this.fields.contact_legal_representative && this.fields.contact_legal_representative.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-2' : 'col-md-3 col-xl-3'">
        <select v-model="form.country_code_legal_representative" class="form-control" name="country_code_legal_representative" id="country_code_legal_representative">
            <option data-countryCode="CO" value="57">Colombia (+57)</option>
            <option data-countryCode="GB" value="44">UK (+44)</option>
            <option data-countryCode="US" value="1">USA (+1)</option>
            <option data-countryCode="DZ" value="213">Algeria (+213)</option>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('distance'), 'has-success': this.fields.distance && this.fields.distance.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
        <input onkeypress="return isNumberKey(event)" type="text" v-model="form.distance" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('distance'), 'form-control-success': this.fields.distance && this.fields.distance.valid}" id="distance" name="distance" placeholder="Distancia (km)">
