...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('distance'), 'has-success': this.fields.distance && this.fields.distance.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
        <input onkeypress="return isNumberKey(event)" type="text" v-model="form.distance" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('distance'), 'form-control-success': this.fields.distance && this.fields.distance.valid}" id="distance" name="distance" placeholder="Distancia">
