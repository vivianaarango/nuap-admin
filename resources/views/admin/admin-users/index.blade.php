            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i>  Administradores
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/admin-users-create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; Nuevo administrador</a>
                    </div>
                    <div class="card-body" v-cloak>
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'position'">Cargo</th>
	                   ...
	                   <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/admin-users-create') }}" role="button"><i class="fa fa-plus"></i>&nbspNuevo administrador</a>
	                    </div>
