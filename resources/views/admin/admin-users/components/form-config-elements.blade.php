<div class="form-group row align-items-center" :class="{'has-danger': errors.has('shipping_cost'), 'has-success': this.fields.shipping_cost && this.fields.shipping_cost.valid }">
    <label for="shipping_cost" class="col-form-label text-md-right" :class="'col-md-3'">Costo de envío</label>
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        @if(isset($config->shipping_cost))
            <input value="{{ $config->shipping_cost }}" type="text" onkeypress="return isNumberKey(event)" required class="form-control" :class="{'form-control-danger': errors.has('shipping_cost'), 'form-control-success': this.fields.shipping_cost && this.fields.shipping_cost.valid}" id="shipping_cost" name="shipping_cost" placeholder="Costo de envío">
        @else
            <input type="text" onkeypress="return isNumberKey(event)" required class="form-control" :class="{'form-control-danger': errors.has('shipping_cost'), 'form-control-success': this.fields.shipping_cost && this.fields.shipping_cost.valid}" id="shipping_cost" name="shipping_cost" placeholder="Costo de envío">
        @endif
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('distance'), 'has-success': this.fields.distance && this.fields.distance.valid }">
    <label for="distance" class="col-form-label text-md-right" :class="'col-md-3'">Distancia</label>
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        @if(isset($config->distance))
            <input value="{{ $config->distance }}" type="text" onkeypress="return isNumberKey(event)" required class="form-control" :class="{'form-control-danger': errors.has('distance'), 'form-control-success': this.fields.distance && this.fields.distance.valid}" id="distance" name="distance" placeholder="Distancia">
        @else
            <input type="text" onkeypress="return isNumberKey(event)" required class="form-control" :class="{'form-control-danger': errors.has('distance'), 'form-control-success': this.fields.distance && this.fields.distance.valid}" id="distance" name="distance" placeholder="Distancia">
        @endif
    ...
    <div class="form-group row align-items-center" :class="{'has-danger': errors.has('owner_document_type'), 'has-success': this.fields.owner_document_type && this.fields.owner_document_type.valid }">
        ...
        <div :class="'col-md-4 col-md-9 col-xl-7'">
            <select required class="form-control" id="owner_document_type" name="owner_document_type">
                <option value="{{ $account->owner_document_type }}">{{ $account->owner_document_type }}</option>
