    ...
    @if($activation =='Administrador')
        <nav class="sidebar-nav">
            <ul class="nav">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/user-create') }}"><i class="nav-icon icon-plus"></i>Nuevo Usuario</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('admin/user-wholesaler-list') }}"><i class="nav-icon icon-user"></i>Mayoristas</a></li>
