...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('sku'), 'has-success': this.fields.sku && this.fields.sku.valid }">
    ...
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        <input value="{{ $product['sku'] }}"  type="text" class="form-control" :class="{'form-control-danger': errors.has('sku'), 'form-control-success': this.fields.sku && this.fields.sku.valid}" id="sku" name="sku" placeholder="Sku">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('brand'), 'has-success': this.fields.brand && this.fields.brand.valid }">
    ...
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        <input value="{{ $product['brand'] }}" type="text" required class="form-control" :class="{'form-control-danger': errors.has('brand'), 'form-control-success': this.fields.brand && this.fields.brand.valid}" id="brand" name="brand" placeholder="Marca">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('stock'), 'has-success': this.fields.stock && this.fields.stock.valid }">
    ...
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        <input value="{{ $product['stock'] }}" type="number" required class="form-control" :class="{'form-control-danger': errors.has('stock'), 'form-control-success': this.fields.stock && this.fields.stock.valid}" id="stock" name="stock" placeholder="Unidades">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('weight'), 'has-success': this.fields.weight && this.fields.weight.valid }">
    ...
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        <input value="{{ $product['weight'] }}" type="number" required class="form-control" :class="{'form-control-danger': errors.has('weight'), 'form-control-success': this.fields.weight && this.fields.weight.valid}" id="weight" name="weight" placeholder="Peso">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('length'), 'has-success': this.fields.length && this.fields.length.valid }">
    ...
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        <input value="{{ $product['length'] }}" type="number" required class="form-control" :class="{'form-control-danger': errors.has('length'), 'form-control-success': this.fields.length && this.fields.length.valid}" id="length" name="length" placeholder="Largo">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('width'), 'has-success': this.fields.width && this.fields.width.valid }">
    ...
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        <input value="{{ $product['width'] }}" type="number" required class="form-control" :class="{'form-control-danger': errors.has('width'), 'form-control-success': this.fields.width && this.fields.width.valid}" id="width" name="width" placeholder="Ancho">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('height'), 'has-success': this.fields.height && this.fields.height.valid }">
    ...
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        <input value="{{ $product['height'] }}" type="number" required class="form-control" :class="{'form-control-danger': errors.has('height'), 'form-control-success': this.fields.height && this.fields.height.valid}" id="height" name="height" placeholder="Alto">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('purchase_price'), 'has-success': this.fields.purchase_price && this.fields.purchase_price.valid }">
    ...
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        <input value="{{ $product['purchase_price'] }}" type="number" required class="form-control" :class="{'form-control-danger': errors.has('purchase_price'), 'form-control-success': this.fields.purchase_price && this.fields.purchase_price.valid}" id="purchase_price" name="purchase_price" placeholder="Precio de Compra">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('sale_price'), 'has-success': this.fields.sale_price && this.fields.sale_price.valid }">
    ...
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        <input value="{{ $product['sale_price'] }}" type="number" required class="form-control" :class="{'form-control-danger': errors.has('sale_price'), 'form-control-success': this.fields.sale_price && this.fields.sale_price.valid}" id="sale_price" name="sale_price" placeholder="Precio de Venta">
...
<div class="form-check row" :class="{'has-danger': errors.has('is_featured'), 'has-success': this.fields.is_featured && this.fields.is_featured.valid }">
    <div class="ml-md-auto" :class="'col-md-9'">
        <input value="{{ $product['is_featured'] }}" class="form-check-input" id="is_featured" type="checkbox" v-validate="''" data-vv-name="is_featured"  name="is_featured">
