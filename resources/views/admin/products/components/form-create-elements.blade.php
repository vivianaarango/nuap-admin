...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('special_price'), 'has-success': this.fields.special_price && this.fields.special_price.valid }">
    ...
    <div :class="'col-md-4 col-md-9 col-xl-7'">
        <input type="number" required class="form-control" :class="{'form-control-danger': errors.has('special_price'), 'form-control-success': this.fields.special_price && this.fields.special_price.valid}" id="special_price" name="special_price" placeholder="Precio Especial">
