<div class="form-group row align-items-center" :class="{'has-danger': errors.has('rut'), 'has-success': this.fields.rut && this.fields.rut.valid }">
    ...
    @if($urls->url_rut == null)
        <a style="background-color: rgb(199, 199, 199) !important; border-color: rgb(210, 210, 210) !important;" target="_blank" class="btn btn-sm btn-link-documents not-active" class="col-auto" href="../../../{{ $urls->url_rut }}" title="Ver" role="button">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('commerce_room'), 'has-success': this.fields.commerce_room && this.fields.commerce_room.valid }">
    ...
    @if($urls->url_commerce_room == null)
        <a style="background-color: rgb(199, 199, 199) !important; border-color: rgb(210, 210, 210) !important;" target="_blank" class="btn btn-sm btn-link-documents not-active" href="../../../{{ $urls->url_commerce_room }}" class="col-auto" href="item.resource_url+'/add-document'" title="Ver" role="button">
            <i class="fa fa-mail-forward"></i>
        </a>
    @else
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('cc_legal_representative'), 'has-success': this.fields.cc_legal_representative && this.fields.cc_legal_representative.valid }">
    ...
    @if($urls->url_cc_legal_representative == null)
        <a style="background-color: rgb(199, 199, 199) !important; border-color: rgb(210, 210, 210) !important;" target="_blank" class="btn btn-sm btn-link-documents not-active" href="../../../{{ $urls->url_cc_legal_representative }}" class="col-auto" href="item.resource_url+'/add-document'" title="Ver" role="button">
            <i class="fa fa-mail-forward"></i>
        </a>
    @else
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('establishment_image'), 'has-success': this.fields.establishment_image && this.fields.establishment_image.valid }">
    ...
    @if($urls->url_establishment_image == null)
        <a style="background-color: rgb(199, 199, 199) !important; border-color: rgb(210, 210, 210) !important;" target="_blank" class="btn btn-sm btn-link-documents not-active" href="../../../{{ $urls->url_establishment_image }}" class="col-auto" href="item.resource_url+'/add-document'" title="Ver" role="button">
            <i class="fa fa-mail-forward"></i>
        </a>
    @else
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('interior_image'), 'has-success': this.fields.interior_image && this.fields.interior_image.valid }">
    ...
    @if($urls->url_interior_image == null)
        <a style="background-color: rgb(199, 199, 199) !important; border-color: rgb(210, 210, 210) !important;" target="_blank" class="btn btn-sm btn-link-documents not-active" href="../../../{{ $urls->url_interior_image }}" class="col-auto" href="item.resource_url+'/add-document'" title="Ver" role="button">
            <i class="fa fa-mail-forward"></i>
        </a>
    @else
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('contract'), 'has-success': this.fields.contract && this.fields.contract.valid }">
    ...
    @if($urls->url_contract == null)
        <a style="background-color: rgb(199, 199, 199) !important; border-color: rgb(210, 210, 210) !important;" target="_blank" class="btn btn-sm btn-link-documents not-active" href="../../../{{ $urls->url_contract }}" class="col-auto" href="item.resource_url+'/add-document'" title="Ver" role="button">
            <i class="fa fa-mail-forward"></i>
        </a>
    @else
