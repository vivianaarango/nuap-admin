...
@section('body')
    ...
    <bulk-action-listing
        :data="{{ $data->toJson() }}"
        :url="'{{ url('admin/commerce-edit-commission') }}'"
                                ...
                                <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="6">
                                        ...
                                        <span class="pull-right pr-2">
                                            ...
                                            <button style="color: white" class="btn btn-sm btn-success pr-3 pl-3" @click="bulkDelete('/admin/commerce-update-commission')">Actualizar comisión</button>
                                        </span>
                                    </td>
                                </tr>
                            </thead>
