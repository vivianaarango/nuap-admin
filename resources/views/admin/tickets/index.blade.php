            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/ticket-create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; Nuevo ticket</a>
                    </div>
                    <div class="card-body" v-cloak>
                        ...
                        <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/ticket-create') }}" role="button"><i class="fa fa-plus"></i>&nbspNuevo ticket</a>
                        </div>
                    </div>
                </div>
            </div>
